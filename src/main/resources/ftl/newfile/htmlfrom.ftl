...
<form class="layui-form layui-form-pane" id="${className2}Form" lay-filter="${className2}Form">
	...
	<div class="layui-fluid" style="padding-bottom: 15px;padding-top: 5px;">
				...
				<div class="layui-form-item layui-row">
					...
					<div class="layui-inline layui-col-md6">
						...
						<div class="layui-input-block">
							...
							<input id="${formItem.name}" name="${formItem.name}" type="text" class="layui-input date-icon" lay-verify="required" xyFlowForm="textinput"/>
							<#else>
							<input id="${formItem.name}" name="${formItem.name}" type="text" class="layui-input" lay-verify="required" xyFlowForm="textinput"/>
							</#if>
						</div>
					</div>
					</#list>
