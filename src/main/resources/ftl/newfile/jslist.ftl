layui.use(['table', 'admin', 'ax', 'func' , 'laydate', 'yx'], function () {
    var $ = layui.$;
    ...
    var tableResult = table.render({
        ...
        queryParams: function(){return ${className}.queryParams()},
        page: true,
        limit:20,
        height: "full-98",
        cellMinWidth: 100,
    ...
    // 导出
    table.on('toolbar(' + ${className}.tableId + ')', function (obj) {
        if (obj.event === 'EXPORT') {
