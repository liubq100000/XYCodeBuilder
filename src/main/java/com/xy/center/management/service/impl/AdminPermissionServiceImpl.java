package com.xy.center.management.service.impl;
...
import com.xy.center.management.dao.BaseAdminPermissionMapper;
import com.xy.center.management.dao.BaseAdminRoleMapper;
...
import com.xy.center.management.service.AdminPermissionService;
...
public class AdminPermissionServiceImpl implements AdminPermissionService {
	...
	public PageDataResult getPermissionList(Integer pageNum, Integer pageSize) {
		...
		System.out.println("******" + permissions.size() + " " + pageNum + " " + pageSize);
